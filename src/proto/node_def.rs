...
//! Generated file from `src/tensorboardrs/proto/node_def.proto`
...
impl NodeDef {
    ...
    // repeated .tensorboardrs.NodeDef.AttrEntry attr = 5;
...
impl ::protobuf::Message for NodeDef {
    ...
    fn default_instance() -> &'static NodeDef {
        static mut instance: ::protobuf::lazy::Lazy<NodeDef> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n&src/tensorboardrs/proto/node_def.proto\x12\rtensorboardrs\x1a(src/ten\
    sorboardrs/proto/attr_value.proto\"\xe4\x01\n\x07NodeDef\x12\x12\n\x04na\
    me\x18\x01\x20\x01(\tR\x04name\x12\x0e\n\x02op\x18\x02\x20\x01(\tR\x02op\
    \x12\x14\n\x05input\x18\x03\x20\x03(\tR\x05input\x12\x16\n\x06device\x18\
    \x04\x20\x01(\tR\x06device\x124\n\x04attr\x18\x05\x20\x03(\x0b2\x20.tens\
    orboardrs.NodeDef.AttrEntryR\x04attr\x1aQ\n\tAttrEntry\x12\x10\n\x03key\
    \x18\x01\x20\x01(\tR\x03key\x12.\n\x05value\x18\x02\x20\x01(\x0b2\x18.te\
    nsorboardrs.AttrValueR\x05value:\x028\x01B*\n\x18org.tensorflow.framewor\
    kB\tNodeProtoP\x01\xf8\x01\x01J\x9d\x13\n\x06\x12\x04\0\0>\x02\n\x08\n\
    ...
    \xbe\x01\n\x04\x04\0\x02\0\x12\x03\x0e\x02\x12\x1a\xb0\x01\x20The\x20nam\
    e\x20given\x20to\x20this\x20operator.\x20Used\x20for\x20naming\x20inputs\
    ,\n\x20logging,\x20visualization,\x20etc.\x20\x20Unique\x20within\x20a\
    \x20single\x20GraphDef.\n\x20Must\x20match\x20the\x20regexp\x20\"[A-Za-z\
    ...
    \x02\x01\x01\x12\x03\x12\t\x0b\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\x12\
    \x0e\x0f\n\xa7\x02\n\x04\x04\0\x02\x02\x12\x03\x19\x02\x1c\x1a\x99\x02\
    \x20Each\x20input\x20is\x20\"node:src_output\"\x20with\x20\"node\"\x20be\
    ing\x20a\x20string\x20name\x20and\n\x20\"src_output\"\x20indicating\x20w\
    hich\x20output\x20tensor\x20to\x20use\x20from\x20\"node\".\x20If\n\x20\"\
    src_output\"\x20is\x200\x20the\x20\":0\"\x20suffix\x20can\x20be\x20omitt\
    ed.\x20\x20Regular\x20inputs\n\x20may\x20optionally\x20be\x20followed\
    \x20by\x20control\x20inputs\x20that\x20have\x20the\x20format\n\x20\"^nod\
    e\".\n\n\x0c\n\x05\x04\0\x02\x02\x04\x12\x03\x19\x02\n\n\x0c\n\x05\x04\0\
    \x02\x02\x05\x12\x03\x19\x0b\x11\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03\
    \x19\x12\x17\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03\x19\x1a\x1b\n\x90\x06\
    \n\x04\x04\0\x02\x03\x12\x03/\x02\x14\x1a\x82\x06\x20A\x20(possibly\x20p\
    artial)\x20specification\x20for\x20the\x20device\x20on\x20which\x20this\
    \n\x20node\x20should\x20be\x20placed.\n\x20The\x20expected\x20syntax\x20\
    for\x20this\x20string\x20is\x20as\x20follows:\n\n\x20DEVICE_SPEC\x20::=\
    \x20PARTIAL_SPEC\n\n\x20PARTIAL_SPEC\x20::=\x20(\"/\"\x20CONSTRAINT)\x20\
    *\n\x20CONSTRAINT\x20::=\x20(\"job:\"\x20JOB_NAME)\n\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20|\x20(\"replica:\"\x20[1-9][0-9]*)\n\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20|\x20(\"task:\"\
    \x20[1-9][0-9]*)\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20|\x20(\x20(\"gpu\"\x20|\x20\"cpu\")\x20\":\"\x20([1-9][0-9]*\x20|\
    \x20\"*\")\x20)\n\n\x20Valid\x20values\x20for\x20this\x20string\x20inclu\
    de:\n\x20*\x20\"/job:worker/replica:0/task:1/gpu:3\"\x20\x20(full\x20spe\
    cification)\n\x20*\x20\"/job:worker/gpu:3\"\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20(partial\x20specificatio\
    n)\n\x20*\x20\"\"\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20(no\x20specification)\n\n\x20If\x20the\x20constraint\
    s\x20do\x20not\x20resolve\x20to\x20a\x20single\x20device\x20(or\x20if\
    \x20this\n\x20field\x20is\x20empty\x20or\x20not\x20present),\x20the\x20r\
    untime\x20will\x20attempt\x20to\n\x20choose\x20a\x20device\x20automatica\
    lly.\n\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03/\x02\x08\n\x0c\n\x05\x04\0\
    \x02\x03\x01\x12\x03/\t\x0f\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03/\x12\
    \x13\n\x94\x05\n\x04\x04\0\x02\x04\x12\x03=\x02\"\x1a\x86\x05\x20Operati\
    on-specific\x20graph-construction-time\x20configuration.\n\x20Note\x20th\
    at\x20this\x20should\x20include\x20all\x20attrs\x20defined\x20in\x20the\
    \n\x20corresponding\x20OpDef,\x20including\x20those\x20with\x20a\x20valu\
    e\x20matching\n\x20the\x20default\x20--\x20this\x20allows\x20the\x20defa\
    ult\x20to\x20change\x20and\x20makes\n\x20NodeDefs\x20easier\x20to\x20int\
    erpret\x20on\x20their\x20own.\x20\x20However,\x20if\n\x20an\x20attr\x20w\
    ith\x20a\x20default\x20is\x20not\x20specified\x20in\x20this\x20list,\x20\
    the\n\x20default\x20will\x20be\x20used.\n\x20The\x20\"names\"\x20(keys)\
    \x20must\x20match\x20the\x20regexp\x20\"[a-z][a-z0-9_]+\"\x20(and\n\x20o\
    ne\x20of\x20the\x20names\x20from\x20the\x20corresponding\x20OpDef's\x20a\
    ttr\x20field).\n\x20The\x20values\x20must\x20have\x20a\x20type\x20matchi\
    ng\x20the\x20corresponding\x20OpDef\n\x20attr's\x20type\x20field.\n\x20T\
    ODO(josh11b):\x20Add\x20some\x20examples\x20here\x20showing\x20best\x20p\
    ractices.\n\n\x0c\n\x05\x04\0\x02\x04\x06\x12\x03=\x02\x18\n\x0c\n\x05\
    \x04\0\x02\x04\x01\x12\x03=\x19\x1d\n\x0c\n\x05\x04\0\x02\x04\x03\x12\
    \x03=\x20!b\x06proto3\
";
